            ...
            <div class="panel-body bio-graph-info">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="col-lg-6">
                            <img src="${pageContext.request.contextPath}${goods.headerImg}" id="show_img"
                                 class="img-responsive"/>
                            <input name="" id="h_img_url" type="hidden"
                                   value="${pageContext.request.contextPath}${goods.headerImg}" class="form-control"/>
                ...
                <form class="form-horizontal" role="form" action="/admin/shop/edit/${goods.gid}" method="post">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label class="col-lg-2 control-label">商品名</label>
                            <div class="col-lg-6">
                                <input name="headerImg" id="headerImg" type="hidden"
                                       value="${pageContext.request.contextPath}${goods.headerImg}"/>
                                <input name="title" value="${goods.title}" required placeholder="输入名称"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required value="${goods.price}" name="price" class="form-control"
                                       placeholder=" 请输入售价">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="number" required name="num" value="${goods.num}" class="form-control"
                                       placeholder=" 请输入数量">
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="txt_content" class="col-lg-2 control-label">商品详细描述</label>
                        <div class="col-lg-12 fb-gray-bg">
                            <textarea name="intro" rows="50" class="form-control"
                                      id="txt_content"
                                      content="">
                                ${goods.intro}
                            </textarea>
