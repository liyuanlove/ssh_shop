...
<head>
    ...
    <link href="${pageContext.request.contextPath}/public/admin/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/public/css/style-responsive.css" rel="stylesheet" type="text/css">
    <link href="<%=request.getContextPath()%>/public/admin/css/tasks.css" rel="stylesheet" type="text/css">
    <%--IE9的HTML5支持--%>
